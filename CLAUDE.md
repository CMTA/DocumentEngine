...
- `doc/img/` — PlantUML **sources** (`*.puml`) plus their rendered `*.png`. The README embeds only
  the images. Re-render with `plantuml -tpng doc/img/<name>.puml` after editing a source, and look
